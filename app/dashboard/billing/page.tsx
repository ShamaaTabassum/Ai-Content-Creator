  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    ...
    <div className="rounded-2xl bg-white border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
      ...
      <a
        ...
        px-12 py-3 text-center text-sm font-medium bg-gray-500 text-white outline-none
          hover:ring-1 focus:outline-none focus:ring "
      >
    ...
    <div className="rounded-2xl bg-white border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
      ...
      //   onClick={()=>CreateSubscription()}
        className='w-full rounded-full mt-5 p-6 active:bg-primary active:text-white active:font-medium hover:border hover:border-purple-500'
        variant='outline'
      >
        Get Started
      </Button>
